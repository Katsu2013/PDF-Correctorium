...
public sealed record ProjectManifest
{
    ...
    /// <summary>形式1.6の自由形状墨消しを失わずに扱える最初のアプリバージョンです。</summary>
    public const string MinimumCompatibleApplicationVersion = "1.0.0-dev.163";
    /// <summary>論理ページ列導入前を含む旧形式1.0～1.5も読み込めます。</summary>
    public static bool IsSupportedVersion(string version) => version is "1.0" or "1.1" or "1.2" or "1.3" or "1.4" or "1.5" or CurrentVersion;
    ...
    public string MinimumApplicationVersion { get; init; } = MinimumCompatibleApplicationVersion;
